    ...
    <body class="text-gray-600 bg-gray-100">
      ...
      <header class="flex justify-between fixed z-30 w-full bg-white">
        ...
        <div
          ...
          <div
            class="flex w-full h-full shadow-inner border border-gray-300 rounded-full focus:border-blue-700 focus:outline-none">
            <input
              class="p-1.5 px-5 w-full border border-gray-300 rounded-l-full focus:border-blue-700 focus:outline-none"
              type="text"
              placeholder="Введите запрос" />
            <button
              class="px-5 text-gray-600 bg-gray-100 border border-gray-300 rounded-r-full hover:bg-gray-200 focus:outline-none">
        ...
        <div class="flex items-center justify-end lg:w-1/4 sm:space-x-3 p-2 sm:px-4">
          ...
          <button class="relative group p-2 focus:outline-none">
            ...
            <div
              class="hidden opacity-0 group-hover:opacity-100 duration-500 absolute top-9 right-0 sm:left-0 bg-white w-60 border border-t-0">
              <section class="py-2">
                <ul>
                  <li>
          ...
          <button class="relative group p-2 focus:outline-none">
            ...
            <div
              class="hidden opacity-0 group-hover:opacity-100 duration-500 absolute top-9 -right-full sm:right-0 bg-white w-72 border border-t-0">
              <section class="py-2 border-b">
                <ul>
                  <li>
          ...
          <button
            class="flex items-center whitespace-nowrap px-3 py-1 text-sm text-blue-700 uppercase border border-blue-700 rounded-full focus:outline-none">
      ...
      <aside class="min-h-screen hidden md:block xl:hidden overflow-auto fixed top-0 pt-14 bg-white z-20">
        <section>
          <ul>
            <li>
              <a class="flex flex-col items-center px-2 py-5 text-red-800 hover:bg-gray-300" href="">
            ...
            <li>
              <a class="flex flex-col items-center px-2 py-5 hover:bg-gray-300" href="#">
                <svg class="w-6 h-6 mb-1.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
      ...
      <!-- main sidebar -->
      <aside class="hidden w-64 xl:block max-h-screen overflow-auto fixed top-0 pt-12 bg-white z-20">
        <section class="py-2 border-b">
          <ul>
            <li>
              <a
        ...
        <section class="py-2 border-b">
          <div class="uppercase text-sm font-semibold px-6 py-2">Best of YahTube</div>
          <ul>
            <li>
              <a class="flex items-center px-6 py-2 text-sm hover:bg-gray-100" href="#">
                <svg class="w-6 h-6 mr-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="py-2 border-b">
          <div class="uppercase text-sm font-semibold px-6 py-2">More from YahTube</div>
          <ul>
            <li>
              <a class="flex items-center px-6 py-2 text-sm hover:bg-gray-100" href="#">
                <svg
        ...
        <section class="px-6 py-4 text-xs font-semibold space-y-4">
          ...
          <div class="font-normal text-gray-500">&copy; 2024 Yahor Yankavets</div>
        </section>
      </aside>
      ...
      <main class="md:ml-24 xl:ml-64 pt-14 bg-gray-100">
        <div class="h-20 sm:h-32 xl:h-52 bg-center bg-cover relative" style="background-image: url(/channel.jpg)">
          <div class="absolute bottom-4 right-4 bg-black bg-opacity-50 sm:bg-opacity-30 p-3 sm:p-2">
            <a href="#" class="flex items-center">
              <svg class="w-5 h-5 mr-2" viewBox="0 0 3364.7 3364.7" xmlns="http://www.w3.org/2000/svg">
                <defs>
        ...
        <div class="max-w-screen-xl m-auto px-20 md:px-6 xl:px-14 pt-4">
          <div class="flex flex-col sm:flex-row justify-between items-start md:items-center mb-4 sm:mb-0">
            <div class="flex items-center">
              <img src="/channel-avatar.jpg" class="h-16 rounded-full mr-5 hidden sm:inline" />
              <div>
                <div class="flex md:items-center">
                  <span class="text-2xl text-gray-800">Cities</span>
                  <svg
                ...
                <div class="text-sm">120K subscribers</div>
              </div>
            </div>
            <button
              class="bg-red-600 text-white text-xs uppercase mt-2 xl:mt-0 py-2 px-4 rounded-sm focus:outline-none">
              Subscribe
            </button>
          </div>
          ...
          <div class="flex items-center">
            <nav class="mt-2">
              <a
                href="#"
                class="px-6 uppercase text-xs font-medium text-gray-500 text-gray-900 border-b-2 border-gray-700 py-3 inline-block">
                Home
              </a>
              <a
                href="#"
                class="px-6 uppercase text-xs font-medium text-gray-500 hover:text-gray-900 py-3 inline-block">
                Videos
              </a>
              <a
                href="#"
                class="px-6 uppercase text-xs font-medium text-gray-500 hover:text-gray-900 py-3 hidden sm:inline-block">
                Playlists
              </a>
              <a
                href="#"
              ...
              <a
                href="#"
                class="px-6 uppercase text-xs font-medium text-gray-500 hover:text-gray-900 py-3 hidden md:inline-block">
                Channels
              </a>
              <a
                href="#"
            ...
            <div class="hidden md:flex items-center ml-6">
              <svg
                class="w-4 h-4 mr-2 mt-1.5 text-gray-500"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <input
                type="text"
                placeholder="Search"
                class="border-b border-gray-700 text-xs py-1 focus:outline-none w-36 bg-transparent" />
            </div>
          </div>
        </div>
        ...
        <div class="max-w-screen-xl m-auto md:px-6 xl:px-14 2xl:px-0">
          <div class="flex flex-col md:flex-row py-6">
            <img class="sm:max-w-sm max-h60" src="https://loremflickr.com/720/404" alt="" />
            <div class="md:pl-6 mt-3 md:mt-0 max-w-md flex flex-col justify-between items-start">
              <div>
                ...
                <div class="text-xs mt-1 md:my-4">186,732 views &middot; 1 day ago</div>
                <div class="text-sm text-black hidden md:block">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex explicabo repudiandae sit est accusamus
                  rem fugiat nihil sunt reiciendis, aut harum illum! Quidem quas, quo earum velit dolore ipsum unde.
                </div>
              </div>
              <a href="#" class="uppercase font-medium text-xs hover:text-black hidden md:inline">Read More</a>
            </div>
          </div>
          ...
          <div class="border-t border-gray-300 pt-5">
            <div class="flex">
              <a href="#" class="font-semibold text-gray-900 mr-6 text-sm">Uploads</a>
              <a href="#" class="flex items-center">
                <svg
                  class="w-5 h-5"
                  fill="none"
            ...
            <!-- all video -->
            <!-- arrows -->
            <div class="mt-5 mb-7 relative">
              <a
                href="#"
                class="bg-white rounded-full shadow-xl w-9 h-9 absolute top-12 xl:top-8 -left-4 z-10 flex justify-center items-center">
                <svg
                  class="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
              ...
              <a
                href="#"
                class="bg-white rounded-full shadow-xl w-9 h-9 absolute top-12 xl:top-8 -right-4 z-10 flex justify-center items-center">
                <svg
                  class="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
              ...
              <div class="flex space-x-1">
                <a href="#" class="group">
                  <div class="relative">
                    <img src="https://loremflickr.com/720/404" />
                    <span
                ...
                <a href="#" class="group hidden sm:inline">
                  <div class="relative">
                    <img src="http://placekitten.com/720/404" />
                    <span
                      class="opacity-0 group-hover:opacity-100 bg-opacity-60 absolute top-0 right-0 bg-black text-white rounded-sm m-1 p-1">
                      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" class="group hidden sm:inline">
                  <div class="relative">
                    <img src="https://baconmockup.com/720/404" />
                    <span
                      class="opacity-0 group-hover:opacity-100 bg-opacity-60 absolute top-0 right-0 bg-black text-white rounded-sm m-1 p-1">
                      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" class="group hidden md:inline">
                  <div class="relative">
                    <img src="https://placebeard.it/720/404" />
                    <span
                      class="opacity-0 group-hover:opacity-100 bg-opacity-60 absolute top-0 right-0 bg-black text-white rounded-sm m-1 p-1">
                      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" class="group hidden xl:inline">
                  <div class="relative">
                    <img src="http://placekitten.com/720/404" />
                    <span
                      class="opacity-0 group-hover:opacity-100 bg-opacity-60 absolute top-0 right-0 bg-black text-white rounded-sm m-1 p-1">
          ...
          <div class="border-t border-gray-300 pt-5">
            <div class="flex">
              <a href="#" class="font-semibold text-gray-900 mr-6 text-sm">Popular uploads</a>
              <a href="#" class="flex items-center">
                <svg
                  class="w-5 h-5"
                  fill="none"
          ...
          <div class="border-t border-gray-300 pt-5 pb-10 relative">
            <a href="#" class="font-semibold text-gray-900 text-sm">Featured Channels</a>

            <a
              href="#"
              class="sm:hidden bg-white rounded-full shadow-xl w-9 h-9 absolute top-24 xl:top-8 -left-4 z-10 flex justify-center items-center">
              <svg
                class="w-5 h-5"
                fill="none"
                stroke="currentColor"
            ...
            <a
              href="#"
              class="sm:hidden bg-white rounded-full shadow-xl w-9 h-9 absolute top-24 xl:top-8 -right-4 z-10 flex justify-center items-center">
              <svg
                class="w-5 h-5"
                fill="none"
                stroke="currentColor"
            ...
            <div class="mt-6 flex">
              <div class="flex flex-col items-center w-full sm:w-1/3 md:w-1/4 xl:w-1/5">
                <a href="#" class="w-full flex flex-col items-center">
                  <img src="https://loremflickr.com/260/260" alt="" class="rounded-full w-24" />
              ...
              <div class="hidden sm:flex flex-col items-center sm:w-1/3 md:w-1/4 xl:w-1/5">
                <a href="#" class="w-full flex flex-col items-center">
                  <img src="https://loremflickr.com/256/256" alt="" class="rounded-full w-24" />
                  <span class="font-semibold text-gray-800 mt-2 mb-4 text-xs">Channel name</span>
                </a>
                <button class="bg-gray-200 uppercase py-1 px-2 text-xs font-medium rounded-sm">Subscribe</button>
              </div>
